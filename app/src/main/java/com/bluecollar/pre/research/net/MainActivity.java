...
public class MainActivity extends ListActivity {
    private static final String CATEGORY_SAMPLE = "com.bluecollar.pre.research.category.SAMPLE_CODE";
    private static final String EXTRA_PROGRAM = "com.bluecollar.pre.research.category.Path";
