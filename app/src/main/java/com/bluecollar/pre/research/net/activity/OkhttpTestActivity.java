        ...
        switch (v.getId()) {
            case R.id.btn_test_string:
                ...
                StringRequest strReq = new StringRequest(url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String arg0) {
                        ...
                        Toast.makeText(OkhttpTestActivity.this, "onResponse返回的长度：" + arg0.length(), Toast.LENGTH_SHORT).show();
                    }
            ...
            case R.id.btn_test_json:
                ...
                JsonObjectRequest joReq = new JsonObjectRequest(url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject arg0) {
                        ...
                        Toast.makeText(OkhttpTestActivity.this, getWeatherInfo(arg0), Toast.LENGTH_SHORT).show();
                    }

                }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError arg0) {
                        Toast.makeText(OkhttpTestActivity.this, "onErrorResponse message->" + arg0.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                // 添加到请求队列中
            ...
            case R.id.btn_test_post:
                ...
                Response.Listener listener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String arg0) {
                        Log.v(LOG_TAG, "StringRequest onResponse result->" + arg0);
                        Toast.makeText(OkhttpTestActivity.this, "onResponse内容：" + arg0, Toast.LENGTH_SHORT).show();
                    }
                };
                ...
                GsonRequest<TestJsonStruct> mjReq = new GsonRequest<TestJsonStruct>(url, TestJsonStruct.class,
                        new Response.Listener<TestJsonStruct>() {
                            ...
                            public void onResponse(TestJsonStruct jsonStruct) {
                                ...
                                Toast.makeText(OkhttpTestActivity.this, city + " " + weatherInfo.getTime() + " 温度是：" + weatherInfo.getTemp() + "°", Toast.LENGTH_SHORT).show();
                            }
                        }, new Response.ErrorListener() {
